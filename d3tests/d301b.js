...
var valueline = d3.line()
    .x(function(d) { return x(d.snarf); })
    .y(function(d) { return y(d.blarf); });
...
d3.csv("test01.csv", function(error, data) {
  ...
  data.forEach(function(d) {
    console.log(d)
      // console.log("fff",d.snarf)
      // d.snarf = new Date(d.snarf, 1)

      console.log("d.snarf: ", d.snarf)
  ...
  x.domain(d3.extent(data, function(d) { return d.snarf; }));
  // y.domain([0, d3.max(data, function(d) { console.log("--",d); return d.blarf; })]);
  y.domain(d3.extent(data, function(d) { console.log("--",d); return d.blarf; }));
